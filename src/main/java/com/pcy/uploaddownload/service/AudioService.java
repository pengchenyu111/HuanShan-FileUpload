...
import com.pcy.uploaddownload.util.ApiResultDto;
import com.pcy.uploaddownload.util.EncryptUtil;
import com.pcy.uploaddownload.util.HttpUtil;
import com.pcy.uploaddownload.util.SliceIdGenerator;
...
public class AudioService {
   ...
   *  设置appid和secret_key
   */
  public static final String APPID = "5e1367d2";
  public static final String SECRET_KEY = "b3349201939f1335edf754e8ead7e4a8";
  ...
  public String main(MultipartFile audio){
    String result = "";
    try {
      FileInputStream fis = (FileInputStream) audio.getInputStream();
      // 预处理
   ...
   * @throws SignatureException
   */
  public static String prepare(MultipartFile audio) throws SignatureException {
...
//        prepareParam.put("lfasr_type", "0");
    // 开启分词
    prepareParam.put("has_participle", "false");
    // 说话人分离
